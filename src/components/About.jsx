...
const About = () => {
  return (
    <div name="about" className='w-full h-screen bg-[#292929] text-gray-300 overflow-hidden'>
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full grid-cols-1 sm:grid-cols-2 gap-8'>
                <div className='sm:text-right pb-8 pl-4'>
                    <p className='text-4xl font-bold inline-block border-b-4 border-[#ccd6f6]'>About</p>
                </div>
                <div>
